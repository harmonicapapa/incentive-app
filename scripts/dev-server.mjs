...
http.createServer(async (req, res) => {
  ...
  let path = url.pathname === '/' ? '/index.html' : url.pathname === '/parent' ? '/parent.html' : url.pathname === '/demo' ? '/demo.html' : (url.pathname === '/examples' || url.pathname === '/examples/') ? '/examples/index.html' : (url.pathname === '/calculator' || url.pathname === '/calculator/') ? '/calculator/index.html' : url.pathname;
